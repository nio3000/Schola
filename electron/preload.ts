...
const WINDOW_TOGGLE_MAXIMIZE_CHANNEL: typeof WINDOW_TOGGLE_MAXIMIZE_CHANNEL_TYPE = 'window:toggle-maximize';
...
const VAULT_RESOLVE_ASSET_URL_CHANNEL: typeof VAULT_RESOLVE_ASSET_URL_CHANNEL_TYPE = 'vault:resolve-asset-url';
...
const VAULT_LIST_IMAGE_ASSETS_CHANNEL: typeof VAULT_LIST_IMAGE_ASSETS_CHANNEL_TYPE = 'vault:list-image-assets';
const WIKI_GET_BACKLINKS_CHANNEL: typeof WIKI_GET_BACKLINKS_CHANNEL_TYPE = 'wiki:get-backlinks';
const WIKI_GET_OUTGOING_LINKS_CHANNEL: typeof WIKI_GET_OUTGOING_LINKS_CHANNEL_TYPE = 'wiki:get-outgoing-links';
const WIKI_GET_UNRESOLVED_LINKS_CHANNEL: typeof WIKI_GET_UNRESOLVED_LINKS_CHANNEL_TYPE = 'wiki:get-unresolved-links';
...
const GRAPH_GET_VAULT_GRAPH_CHANNEL: typeof GRAPH_GET_VAULT_GRAPH_CHANNEL_TYPE = 'graph:get-vault-graph';
...
const RUNTIME_CANCEL_INSTALL_CHANNEL: typeof RUNTIME_CANCEL_INSTALL_CHANNEL_TYPE = 'runtime:cancel-install';
...
const RUNTIME_EXPORT_DIAGNOSTICS_CHANNEL: typeof RUNTIME_EXPORT_DIAGNOSTICS_CHANNEL_TYPE = 'runtime:export-diagnostics';
const AI_RESEARCH_GET_PROVIDER_READINESS_CHANNEL: typeof AI_RESEARCH_GET_PROVIDER_READINESS_CHANNEL_TYPE = 'ai-research:get-provider-readiness';
const AI_RESEARCH_BUILD_CONTEXT_PACK_CHANNEL: typeof AI_RESEARCH_BUILD_CONTEXT_PACK_CHANNEL_TYPE = 'ai-research:build-context-pack';
const AI_RESEARCH_PREVIEW_CONTEXT_PACK_CHANNEL: typeof AI_RESEARCH_PREVIEW_CONTEXT_PACK_CHANNEL_TYPE = 'ai-research:preview-context-pack';
const AI_RESEARCH_CREATE_TASK_DRAFT_CHANNEL: typeof AI_RESEARCH_CREATE_TASK_DRAFT_CHANNEL_TYPE = 'ai-research:create-task-draft';
const AI_RESEARCH_RUN_CONFIRMED_TASK_CHANNEL: typeof AI_RESEARCH_RUN_CONFIRMED_TASK_CHANNEL_TYPE = 'ai-research:run-confirmed-task';
const AI_RESEARCH_CANCEL_TASK_CHANNEL: typeof AI_RESEARCH_CANCEL_TASK_CHANNEL_TYPE = 'ai-research:cancel-task';
const AI_RESEARCH_GET_TASK_STATUS_CHANNEL: typeof AI_RESEARCH_GET_TASK_STATUS_CHANNEL_TYPE = 'ai-research:get-task-status';
const AI_RESEARCH_GET_TASK_RESULT_CHANNEL: typeof AI_RESEARCH_GET_TASK_RESULT_CHANNEL_TYPE = 'ai-research:get-task-result';
const AI_RESEARCH_CLEAR_TASK_RESULT_CHANNEL: typeof AI_RESEARCH_CLEAR_TASK_RESULT_CHANNEL_TYPE = 'ai-research:clear-task-result';
const AI_RESEARCH_DISCARD_ARTIFACT_CHANNEL: typeof AI_RESEARCH_DISCARD_ARTIFACT_CHANNEL_TYPE = 'ai-research:discard-artifact';
const SETTINGS_GET_PROVIDER_PRESETS_CHANNEL: typeof SETTINGS_GET_PROVIDER_PRESETS_CHANNEL_TYPE = 'settings:get-provider-presets';
const SETTINGS_GET_PROVIDER_CONFIGS_CHANNEL: typeof SETTINGS_GET_PROVIDER_CONFIGS_CHANNEL_TYPE = 'settings:get-provider-configs';
const SETTINGS_SET_PROVIDER_CONFIG_CHANNEL: typeof SETTINGS_SET_PROVIDER_CONFIG_CHANNEL_TYPE = 'settings:set-provider-config';
const SETTINGS_GET_PROVIDER_MODELS_CHANNEL: typeof SETTINGS_GET_PROVIDER_MODELS_CHANNEL_TYPE = 'settings:get-provider-models';
const SETTINGS_GET_API_KEY_STATUS_CHANNEL: typeof SETTINGS_GET_API_KEY_STATUS_CHANNEL_TYPE = 'settings:get-api-key-status';
const SETTINGS_SET_API_KEY_CHANNEL: typeof SETTINGS_SET_API_KEY_CHANNEL_TYPE = 'settings:set-api-key';
const SETTINGS_CLEAR_API_KEY_CHANNEL: typeof SETTINGS_CLEAR_API_KEY_CHANNEL_TYPE = 'settings:clear-api-key';
const SETTINGS_GET_PRIVACY_CONSENT_CHANNEL: typeof SETTINGS_GET_PRIVACY_CONSENT_CHANNEL_TYPE = 'settings:get-privacy-consent';
const SETTINGS_SET_PRIVACY_CONSENT_CHANNEL: typeof SETTINGS_SET_PRIVACY_CONSENT_CHANNEL_TYPE = 'settings:set-privacy-consent';
const SETTINGS_GET_CONTEXT_SEND_POLICY_CHANNEL: typeof SETTINGS_GET_CONTEXT_SEND_POLICY_CHANNEL_TYPE = 'settings:get-context-send-policy';
const SETTINGS_SET_CONTEXT_SEND_POLICY_CHANNEL: typeof SETTINGS_SET_CONTEXT_SEND_POLICY_CHANNEL_TYPE = 'settings:set-context-send-policy';
const SETTINGS_GET_AI_PREFERENCES_CHANNEL: typeof SETTINGS_GET_AI_PREFERENCES_CHANNEL_TYPE = 'settings:get-ai-preferences';
const SETTINGS_SET_AI_PREFERENCES_CHANNEL: typeof SETTINGS_SET_AI_PREFERENCES_CHANNEL_TYPE = 'settings:set-ai-preferences';
const SETTINGS_GET_CONFIRMATION_LOG_CHANNEL: typeof SETTINGS_GET_CONFIRMATION_LOG_CHANNEL_TYPE = 'settings:get-confirmation-log';
const IMPORT_SELECT_SOURCE_CHANNEL: typeof IMPORT_SELECT_SOURCE_CHANNEL_TYPE = 'import:select-source';
const IMPORT_CREATE_JOB_CHANNEL: typeof IMPORT_CREATE_JOB_CHANNEL_TYPE = 'import:create-job';
const IMPORT_GET_JOB_STATUS_CHANNEL: typeof IMPORT_GET_JOB_STATUS_CHANNEL_TYPE = 'import:get-job-status';
...
const IMPORT_GET_AVAILABLE_MODES_CHANNEL: typeof IMPORT_GET_AVAILABLE_MODES_CHANNEL_TYPE = 'import:get-available-modes';
const IMPORT_OPEN_ORIGINAL_FILE_CHANNEL: typeof IMPORT_OPEN_ORIGINAL_FILE_CHANNEL_TYPE = 'import:open-original-file';
const IMPORT_REVEAL_ORIGINAL_FILE_CHANNEL: typeof IMPORT_REVEAL_ORIGINAL_FILE_CHANNEL_TYPE = 'import:reveal-original-file';
const EXPORT_CREATE_JOB_CHANNEL: typeof EXPORT_CREATE_JOB_CHANNEL_TYPE = 'export:create-job';
const EXPORT_GET_JOB_STATUS_CHANNEL: typeof EXPORT_GET_JOB_STATUS_CHANNEL_TYPE = 'export:get-job-status';
...
const INDEX_SYNC_FILE_EVENTS_CHANNEL: typeof INDEX_SYNC_FILE_EVENTS_CHANNEL_TYPE = 'index:sync-file-events';
...
const NOTE_DELETE_PERMANENT_CHANNEL: typeof NOTE_DELETE_PERMANENT_CHANNEL_TYPE = 'note:delete-permanent';
const FOLDER_DELETE_CHANNEL: typeof FOLDER_DELETE_CHANNEL_TYPE = 'folder:delete';
const FOLDER_DELETE_PERMANENT_CHANNEL: typeof FOLDER_DELETE_PERMANENT_CHANNEL_TYPE = 'folder:delete-permanent';
...
const ARTIFACT_OPEN_GENERATED_MARKDOWN_CHANNEL: typeof ARTIFACT_OPEN_GENERATED_MARKDOWN_CHANNEL_TYPE = 'artifact:open-generated-markdown';
const ARTIFACT_REVEAL_GENERATED_MARKDOWN_CHANNEL: typeof ARTIFACT_REVEAL_GENERATED_MARKDOWN_CHANNEL_TYPE = 'artifact:reveal-generated-markdown';
const ARTIFACT_OPEN_EXPORT_ARTIFACT_CHANNEL: typeof ARTIFACT_OPEN_EXPORT_ARTIFACT_CHANNEL_TYPE = 'artifact:open-export-artifact';
const ARTIFACT_REVEAL_EXPORT_ARTIFACT_CHANNEL: typeof ARTIFACT_REVEAL_EXPORT_ARTIFACT_CHANNEL_TYPE = 'artifact:reveal-export-artifact';
...
const scholaApi: ScholaApi = Object.freeze({
  app: Object.freeze({
    ...
    notifyRendererReady: () => { ipcRenderer.send(APP_RENDERER_READY_CHANNEL); },
    perfLog: (message: string) => { ipcRenderer.send(APP_PERF_LOG_CHANNEL, message); },
  }),
  ...
  vault: Object.freeze({
    ...
    resolvePreviewAssetUrl: (vaultId: string, noteRelativePath: string, assetPath: string) =>
      ipcRenderer.invoke(VAULT_RESOLVE_ASSET_URL_CHANNEL, vaultId, noteRelativePath, assetPath) as Promise<string>,
    scanVault: (vaultId: string) => ipcRenderer.invoke(VAULT_SCAN_CHANNEL, vaultId) as Promise<readonly FileEntry[]>,
    listImageAssets: (vaultId: string) =>
      ipcRenderer.invoke(VAULT_LIST_IMAGE_ASSETS_CHANNEL, vaultId) as Promise<readonly ImageAsset[]>,
    getRecentVaults: () => ipcRenderer.invoke(VAULT_GET_RECENT_CHANNEL) as Promise<readonly VaultInfo[]>,
    closeVault: (vaultId: string) => ipcRenderer.invoke(VAULT_CLOSE_CHANNEL, vaultId) as Promise<void>,
    onFileEvent: (callback: (events: readonly VaultFileEvent[]) => void): (() => void) => {
      const handler = (_event: Electron.IpcRendererEvent, events: readonly VaultFileEvent[]): void => {
        callback(events);
      };
    ...
    syncFileEvents: (vaultId: string, events: readonly VaultFileEvent[]) =>
      ipcRenderer.invoke(INDEX_SYNC_FILE_EVENTS_CHANNEL, vaultId, events) as Promise<IndexSyncResult>,
  }),
  note: Object.freeze({
    ...
    saveNote: (vaultId: string, relativePath: string, content: string, expectedHash: string | null) =>
      ipcRenderer.invoke(NOTE_SAVE_CHANNEL, vaultId, relativePath, content, expectedHash) as Promise<SaveNoteResult>,
    ...
    deleteNotePermanent: (vaultId: string, input: DeleteEntryInput) =>
      ipcRenderer.invoke(NOTE_DELETE_PERMANENT_CHANNEL, vaultId, input) as Promise<DeleteNoteOutcome>,
    ...
    deleteFolderPermanent: (vaultId: string, input: DeleteEntryInput) =>
      ipcRenderer.invoke(FOLDER_DELETE_PERMANENT_CHANNEL, vaultId, input) as Promise<DeleteFolderOutcome>,
  ...
  wiki: Object.freeze({
    getBacklinks: (vaultId: string, relativePath: string) =>
      ipcRenderer.invoke(WIKI_GET_BACKLINKS_CHANNEL, vaultId, relativePath) as Promise<GetBacklinksResult>,
    getOutgoingLinks: (vaultId: string, relativePath: string) =>
      ipcRenderer.invoke(WIKI_GET_OUTGOING_LINKS_CHANNEL, vaultId, relativePath) as Promise<GetOutgoingResult>,
    getUnresolvedLinks: (vaultId: string, relativePath: string) =>
      ipcRenderer.invoke(WIKI_GET_UNRESOLVED_LINKS_CHANNEL, vaultId, relativePath) as Promise<GetUnresolvedResult>,
  }),
  ...
  graph: Object.freeze({
    getVaultGraph: (input: GetVaultGraphInput) =>
      ipcRenderer.invoke(GRAPH_GET_VAULT_GRAPH_CHANNEL, input.vaultId, input.options ?? {}) as Promise<GetVaultGraphResult>,
  }),
  import: Object.freeze({
    ...
    getJobStatus: (vaultId: string, jobId: string) =>
      ipcRenderer.invoke(IMPORT_GET_JOB_STATUS_CHANNEL, vaultId, jobId) as Promise<GetImportJobStatusResult>,
    ...
    cancelJob: (vaultId: string, jobId: string) =>
      ipcRenderer.invoke(IMPORT_CANCEL_JOB_CHANNEL, vaultId, jobId) as Promise<CancelImportJobResult>,
    getAvailableModes: () =>
    ...
    openOriginalFile: (vaultId: string, originalFileRef: string) =>
      ipcRenderer.invoke(IMPORT_OPEN_ORIGINAL_FILE_CHANNEL, vaultId, originalFileRef) as Promise<OpenOriginalImportFileResult>,
    revealOriginalFile: (vaultId: string, originalFileRef: string) =>
      ipcRenderer.invoke(IMPORT_REVEAL_ORIGINAL_FILE_CHANNEL, vaultId, originalFileRef) as Promise<RevealOriginalImportFileResult>,
  }),
  export: Object.freeze({
    ...
    getJobStatus: (vaultId: string, jobId: string) =>
      ipcRenderer.invoke(EXPORT_GET_JOB_STATUS_CHANNEL, vaultId, jobId) as Promise<GetExportJobStatusResult>,
    listJobs: (vaultId: string) =>
      ipcRenderer.invoke(EXPORT_LIST_JOBS_CHANNEL, vaultId) as Promise<ListExportJobsResult>,
    cancelJob: (vaultId: string, jobId: string) =>
      ipcRenderer.invoke(EXPORT_CANCEL_JOB_CHANNEL, vaultId, jobId) as Promise<CancelExportJobResult>,
  }),
  artifact: Object.freeze({
    openGeneratedMarkdown: (vaultId: string, relativePath: string) =>
      ipcRenderer.invoke(ARTIFACT_OPEN_GENERATED_MARKDOWN_CHANNEL, vaultId, relativePath) as Promise<ArtifactOpenResult>,
    revealGeneratedMarkdown: (vaultId: string, relativePath: string) =>
      ipcRenderer.invoke(ARTIFACT_REVEAL_GENERATED_MARKDOWN_CHANNEL, vaultId, relativePath) as Promise<ArtifactOpenResult>,
    openExportArtifact: (vaultId: string, relativePath: string) =>
      ipcRenderer.invoke(ARTIFACT_OPEN_EXPORT_ARTIFACT_CHANNEL, vaultId, relativePath) as Promise<ArtifactOpenResult>,
    revealExportArtifact: (vaultId: string, relativePath: string) =>
      ipcRenderer.invoke(ARTIFACT_REVEAL_EXPORT_ARTIFACT_CHANNEL, vaultId, relativePath) as Promise<ArtifactOpenResult>,
  }),
  ...
  runtime: Object.freeze({
    listPacks: () =>
      Promise.resolve({ ok: true, packs: [] }) as Promise<ListRuntimePacksResult>,
    getStatus: () =>
      Promise.resolve({ ok: false, status: null }),
    install: () =>
      Promise.resolve({ ok: false, message: 'Runtime Pack 已暂停。后续版本开放。' } as InstallRuntimePackResult),
    cancelInstall: () =>
      Promise.resolve({ ok: false } as CancelInstallRuntimePackResult),
    uninstall: () =>
      Promise.resolve({ ok: false } as UninstallRuntimePackResult),
    enable: () =>
      Promise.resolve({ ok: false } as ToggleRuntimePackResult),
    disable: () =>
      Promise.resolve({ ok: false } as ToggleRuntimePackResult),
    probe: () =>
      Promise.resolve({ ok: false, available: false } as ProbeRuntimePackResult),
    diagnose: () =>
      Promise.resolve({ ok: false, checks: [] } as DiagnoseRuntimePackResult),
    clearCache: () =>
      Promise.resolve({ ok: false, freedDiskMb: 0 } as ClearRuntimePackCacheResult),
    exportDiagnostics: () =>
  ...
  aiResearch: Object.freeze<ScholaAIResearchApi>({
    getProviderReadiness: (providerId?: string) =>
      ipcRenderer.invoke(AI_RESEARCH_GET_PROVIDER_READINESS_CHANNEL, providerId ?? null) as Promise<readonly ProviderReadiness[]>,
    buildContextPack: (input: BuildContextPackInput) =>
      ipcRenderer.invoke(AI_RESEARCH_BUILD_CONTEXT_PACK_CHANNEL, input) as Promise<ResearchContextPreview>,
    previewContextPack: (contextPackId: string) =>
      ipcRenderer.invoke(AI_RESEARCH_PREVIEW_CONTEXT_PACK_CHANNEL, contextPackId) as Promise<ResearchContextPreview>,
    createTaskDraft: (input: CreateTaskDraftInput) =>
      ipcRenderer.invoke(AI_RESEARCH_CREATE_TASK_DRAFT_CHANNEL, input) as Promise<AIResearchTaskStatus>,
    runConfirmedTask: (input: RunConfirmedTaskInput) =>
      ipcRenderer.invoke(AI_RESEARCH_RUN_CONFIRMED_TASK_CHANNEL, input) as Promise<AIResearchTaskStatus>,
    ...
    getTaskStatus: (taskId: string) =>
      ipcRenderer.invoke(AI_RESEARCH_GET_TASK_STATUS_CHANNEL, taskId) as Promise<AIResearchTaskStatus>,
    getTaskResult: (taskId: string) =>
      ipcRenderer.invoke(AI_RESEARCH_GET_TASK_RESULT_CHANNEL, taskId) as Promise<AIResearchTaskResult>,
  ...
  settings: Object.freeze<ScholaSettingsApi>({
    getProviderPresets: () =>
      ipcRenderer.invoke(SETTINGS_GET_PROVIDER_PRESETS_CHANNEL) as Promise<readonly ProviderPreset[]>,
    getProviderConfigs: () =>
      ipcRenderer.invoke(SETTINGS_GET_PROVIDER_CONFIGS_CHANNEL) as Promise<readonly ProviderConfig[]>,
    setProviderConfig: (providerId: string, config: Partial<ProviderConfig>) =>
      ipcRenderer.invoke(SETTINGS_SET_PROVIDER_CONFIG_CHANNEL, providerId, config) as Promise<ProviderConfig>,
    getProviderModels: (providerId: string) =>
      ipcRenderer.invoke(SETTINGS_GET_PROVIDER_MODELS_CHANNEL, providerId) as Promise<readonly AIModelInfo[]>,
    getApiKeyStatus: (providerId?: string) =>
      ipcRenderer.invoke(SETTINGS_GET_API_KEY_STATUS_CHANNEL, providerId ?? null) as Promise<readonly MaskedSecretStatus[]>,
    setApiKey: (providerId: string, key: string) =>
      ipcRenderer.invoke(SETTINGS_SET_API_KEY_CHANNEL, providerId, key) as Promise<MaskedSecretStatus>,
    clearApiKey: (providerId: string) =>
      ipcRenderer.invoke(SETTINGS_CLEAR_API_KEY_CHANNEL, providerId) as Promise<MaskedSecretStatus>,
    getPrivacyConsent: () =>
      ipcRenderer.invoke(SETTINGS_GET_PRIVACY_CONSENT_CHANNEL) as Promise<PrivacyConsentState | null>,
    setPrivacyConsent: (consent: PrivacyConsentState) =>
      ipcRenderer.invoke(SETTINGS_SET_PRIVACY_CONSENT_CHANNEL, consent) as Promise<PrivacyConsentState>,
    ...
    setContextSendPolicy: (policy: ContextSendPolicy) =>
      ipcRenderer.invoke(SETTINGS_SET_CONTEXT_SEND_POLICY_CHANNEL, policy) as Promise<ContextSendPolicy>,
    getAIPreferences: () =>
    ...
    getConfirmationLog: (limit?: number) =>
      ipcRenderer.invoke(SETTINGS_GET_CONFIRMATION_LOG_CHANNEL, limit ?? null) as Promise<readonly ConfirmationLogEntry[]>,
  }),
